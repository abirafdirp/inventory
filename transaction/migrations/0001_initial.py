    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(max_length=35, choices=[(b'Warehouse', b'Warehouse'), (b'Store', b'Store'), (b'Refurbish/Recycling Center/Landfill', b'Refurbish/Recycling Center/Landfill'), (b'supplier', b'Supplier')])),
